...
{  
	...
	static int startGame(int minValue,int maxValue)
	{  
       ...
       while(true)
		{
		   ...
		   System.out.println("\nEnter your guess between ("+minValue+"-"+maxValue+") : ");
   ...
   public static void main(String[] args)
	{ 
		...
		int round=startGame(minValue,maxValue);
